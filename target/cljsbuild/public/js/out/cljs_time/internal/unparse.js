...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__45248 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,(function (p1__45247_SHARP_){
return cljs.core.subs.call(null,p1__45247_SHARP_,(0),(3));
}),G__45248);
} else {
return G__45248;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__45257){
var vec__45258 = p__45257;
var t = cljs.core.nth.call(null,vec__45258,(0),null);
var pattern = cljs.core.nth.call(null,vec__45258,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__45261 = pattern;
switch (G__45261) {
case "S":
...
return p1__45263_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__45264_SHARP_){
return p1__45264_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__45265_SHARP_){
return p1__45265_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__45266_SHARP_){
return p1__45266_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__45267_SHARP_){
return p1__45267_SHARP_.getHours();
});

break;
case "day":
return (function (p1__45268_SHARP_){
return p1__45268_SHARP_.getDate();
});

break;
case "month":
return (function (p1__45269_SHARP_){
return p1__45269_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__45270_SHARP_){
return p1__45270_SHARP_.getYear();
});
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__45273){
...
var key = first__45276;
var args = seq__45275__$1;
var G__45277 = key;
...
break;
case "ordinal-suffix":
var vec__45278 = syntax_list.call(null,(i - (1)));
var k = cljs.core.nth.call(null,vec__45278,(0),null);
...
var d = value;
var G__45285 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__45286 = G__45285;
var seq__45287 = cljs.core.seq.call(null,vec__45286);
var first__45288 = cljs.core.first.call(null,seq__45287);
var seq__45287__$1 = cljs.core.next.call(null,seq__45287);
var unparser = first__45288;
var more = seq__45287__$1;
var s = "";
var d__$1 = d;
var G__45285__$1 = G__45285;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__45295 = G__45285__$1;
var seq__45296 = cljs.core.seq.call(null,vec__45295);
var first__45297 = cljs.core.first.call(null,seq__45296);
var seq__45296__$1 = cljs.core.next.call(null,seq__45296);
var unparser__$1 = first__45297;
var more__$1 = seq__45296__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__45298 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__45298,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__45298,(1),null);
var G__45301 = d__$3;
var G__45302 = more__$1;
var G__45303 = s__$3;
d__$1 = G__45301;
G__45285__$1 = G__45302;
s__$1 = G__45303;
continue;
}
break;
...
//# sourceMappingURL=unparse.js.map?rel=1606929283105
