...
var G__45402 = o;
goog.object.set(G__45402,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__45406 = o;
goog.object.set(G__45406,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__45407__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__45407 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__45408__i < G__45408__a.length) {G__45408__a[G__45408__i] = arguments[G__45408__i + 0]; ++G__45408__i;}
  args = new cljs.core.IndexedSeq(G__45408__a,0,null);
} 
return G__45407__delegate.call(this,args);};
G__45407.cljs$lang$maxFixedArity = 0;
G__45407.cljs$lang$applyTo = (function (arglist__45409){
var args = cljs.core.seq(arglist__45409);
return G__45407__delegate(args);
});
...
var G__45410 = props;
var G__45410__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__45410,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__45410);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__45410__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__45410__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__45411 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__45411,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__45411;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__45412){
...
var on_write = cljs.core.get.call(null,map__45413__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__45415_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__45415_SHARP_);
}));
} else {
return null;
}
...
var vec__45418 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__45418,(0),null);
var id = cljs.core.nth.call(null,vec__45418,(1),null);
var className = cljs.core.nth.call(null,vec__45418,(2),null);
...
var temp__5739__auto___45422 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___45422 == null)){
} else {
var key_45423 = temp__5739__auto___45422;
(jsprops.key = key_45423);
}
...
var temp__5739__auto___45424 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___45424 == null)){
} else {
var key_45425 = temp__5739__auto___45424;
(jsprops.key = key_45425);
}
...
var temp__5739__auto___45426 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___45426 == null)){
} else {
var key_45427 = temp__5739__auto___45426;
(jsprops.key = key_45427);
}
...
var G__45429 = n;
if(cljs.core._EQ_.call(null,"",G__45429)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__45429)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq45430){
var G__45431 = cljs.core.first.call(null,seq45430);
var seq45430__$1 = cljs.core.next.call(null,seq45430);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45431,seq45430__$1);
}));
...
break;
default:
var G__45437 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__45437;
continue;
...
var ctx = ({});
var vec__45439 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__45439,(0),null);
var derefed = cljs.core.nth.call(null,vec__45439,(1),null);
...
var G__45442 = (cljs.core.count.call(null,argv) - first_child);
switch (G__45442) {
case (0):
...
//# sourceMappingURL=template.js.map?rel=1606929283513
