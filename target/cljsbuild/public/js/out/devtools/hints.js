...
}catch (e47471){var _e = e47471;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___47474 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___47474)){
var seen_errors_47475 = temp__5733__auto___47474;
if(cljs.core.truth_(seen_errors_47475.has(self))){
} else {
seen_errors_47475.add(self);

var temp__5735__auto___47476 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___47476)){
var sense_47477 = temp__5735__auto___47476;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_47477)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1606929286883
