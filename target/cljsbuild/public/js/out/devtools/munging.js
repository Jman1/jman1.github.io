...
var o34979 = temp__5733__auto__;
var temp__5733__auto____$1 = (o34979["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o34980 = temp__5733__auto____$1;
return (o34980["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__34122__auto__ = f;
return (o__34122__auto__["toString"]).call(o__34122__auto__);
} else {
return "";
}
}catch (e34981){var _ = e34981;
return "";
}});
...
try{var o__34122__auto___34983 = t;
(o__34122__auto___34983["cljs$lang$ctorPrWriter"]).call(o__34122__auto___34983,t,writer);
}catch (e34982){var __34984 = e34982;
}
...
var char_code = (function (){var o__34122__auto__ = (new String(char$));
return (o__34122__auto__["charCodeAt"]).call(o__34122__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__34122__auto__ = String;
return (o__34122__auto__["fromCharCode"]).call(o__34122__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__34985 = num_code;
switch (G__34985) {
case (1):
return (185);
...
var o__34122__auto__ = String;
return (o__34122__auto__["fromCharCode"]).call(o__34122__auto__,superscript_code);
});
/**
...
}catch (e34987){var _e__34129__auto__ = e34987;
return false;
}})())){
...
var vec__34988 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__34988,(0),null);
...
var len__4736__auto___34997 = arguments.length;
var i__4737__auto___34998 = (0);
while(true){
if((i__4737__auto___34998 < len__4736__auto___34997)){
args__4742__auto__.push((arguments[i__4737__auto___34998]));

var G__34999 = (i__4737__auto___34998 + (1));
i__4737__auto___34998 = G__34999;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__34993){
var vec__34994 = p__34993;
var ns_detector = cljs.core.nth.call(null,vec__34994,(0),null);
...
var G__35000 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__35001 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__35000;
remaining_tokens = G__35001;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq34991){
var G__34992 = cljs.core.first.call(null,seq34991);
var seq34991__$1 = cljs.core.next.call(null,seq34991);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34992,seq34991__$1);
}));
...
var vec__35005 = cljs.core.split_with.call(null,(function (p1__35004_SHARP_){
return cljs.core.not_EQ_.call(null,p1__35004_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__35005,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__35005,(1),null);
...
var vec__35011 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__35011,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__35011,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__35014 = cljs.core.rest.call(null,remaining_tokens);
var G__35015 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__35014;
name_tokens = G__35015;
continue;
} else {
...
var vec__35018 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__35018,(0),null);
var arity = cljs.core.nth.call(null,vec__35018,(1),null);
var vec__35021 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__35021,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__35021,(1),null);
var vec__35024 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__35024,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__35024,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__35024,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__35024,(3),null);
...
var vec__35030 = result;
var munged_ns = cljs.core.nth.call(null,vec__35030,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__35030,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__35030,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__35030,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__35030,(4),null);
var arity = cljs.core.nth.call(null,vec__35030,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__35034 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__35034,(0),null);
var args = cljs.core.nth.call(null,vec__35034,(1),null);
var vec__35037 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__35037,(0),null);
var name = cljs.core.nth.call(null,vec__35037,(1),null);
...
var G__35040 = (arity + (1));
var G__35041 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__35042){
var vec__35043 = p__35042;
var arity = cljs.core.nth.call(null,vec__35043,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__35043,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__35046_SHARP_){
return cljs.core.get.call(null,arities,p1__35046_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__35047_SHARP_){
return cljs.core.drop.call(null,(2),p1__35047_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__35050){
var vec__35051 = p__35050;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__35051,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq35048){
var G__35049 = cljs.core.first.call(null,seq35048);
var seq35048__$1 = cljs.core.next.call(null,seq35048);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35049,seq35048__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__35059__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__35059__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__35059__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__35059__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__35060 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__35060,(0),null);
var fn_name = cljs.core.nth.call(null,vec__35060,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__35060,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__35060,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__35060,(4),null);
var arity = cljs.core.nth.call(null,vec__35060,(5),null);
...
var o__34122__auto__ = f;
return (o__34122__auto__["getBasis"]).call(o__34122__auto__);
});
/**
...
}catch (e35064){var _e__34129__auto__ = e35064;
...
var G__35065 = (obj[cljs.core.first.call(null,path)]);
var G__35066 = cljs.core.rest.call(null,path);
obj = G__35065;
path = G__35066;
continue;
} else {
...
var _STAR_ = (function (accum,p__35067){
var vec__35068 = p__35067;
var bit = cljs.core.nth.call(null,vec__35068,(0),null);
var protocol = cljs.core.nth.call(null,vec__35068,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__35071){
var vec__35072 = p__35071;
var ns = cljs.core.nth.call(null,vec__35072,(0),null);
var name = cljs.core.nth.call(null,vec__35072,(1),null);
var selector = cljs.core.nth.call(null,vec__35072,(2),null);
...
var post_process = (function (p__35076){
var vec__35077 = p__35076;
var munged_name = cljs.core.nth.call(null,vec__35077,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__35077,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__35075_SHARP_){
return (obj[cljs.core.first.call(null,p1__35075_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1606929268500
