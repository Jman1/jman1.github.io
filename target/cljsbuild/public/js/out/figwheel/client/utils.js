...
return (new CustomEvent(event_name,(function (){var obj56129 = ({"detail":data});
return obj56129;
})()));
} else {
...
var f = (function (){var pred__56136 = cljs.core._EQ_;
var expr__56137 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__56136.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__56137))){
return (function (p1__56130_SHARP_){
return console.warn(p1__56130_SHARP_);
});
} else {
if(cljs.core.truth_(pred__56136.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__56137))){
return (function (p1__56131_SHARP_){
return console.debug(p1__56131_SHARP_);
});
} else {
if(cljs.core.truth_(pred__56136.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__56137))){
return (function (p1__56132_SHARP_){
return console.error(p1__56132_SHARP_);
});
} else {
return (function (p1__56133_SHARP_){
return console.log(p1__56133_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__56140){
var map__56141 = p__56140;
var map__56141__$1 = (((((!((map__56141 == null))))?(((((map__56141.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56141.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56141):map__56141);
var opts = map__56141__$1;
var eval_fn = cljs.core.get.call(null,map__56141__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__56143_SHARP_){
return new_def.callback(p1__56143_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__56144){
var vec__56145 = p__56144;
var ky = cljs.core.nth.call(null,vec__56145,(0),null);
var v = cljs.core.nth.call(null,vec__56145,(1),null);
...
}catch (e56150){if((e56150 instanceof Error)){
var e = e56150;
return not_found;
} else {
throw e56150;
...
//# sourceMappingURL=utils.js.map?rel=1606929296391
