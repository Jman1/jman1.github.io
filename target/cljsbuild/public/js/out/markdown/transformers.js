...
var and__4115__auto__ = cljs.core.not_empty.call(null,trimmed);
...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__42100){
...
var state = map__42101__$1;
var code = cljs.core.get.call(null,map__42101__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__42101__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var or__4126__auto__ = markdown.transformers.h1_QMARK_.call(null,text);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
var G__42103 = cljs.core.into.call(null,buf,cljs.core.concat.call(null,cljs.core.seq.call(null,"<sup>"),cljs.core.second.call(null,remaining),cljs.core.seq.call(null,"</sup>")));
var G__42104 = cljs.core.drop.call(null,(2),remaining);
buf = G__42103;
remaining = G__42104;
continue;
} else {
var G__42105 = cljs.core.into.call(null,buf,cljs.core.first.call(null,remaining));
var G__42106 = cljs.core.rest.call(null,remaining);
buf = G__42105;
remaining = G__42106;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__42107){
var map__42108 = p__42107;
var map__42108__$1 = (((((!((map__42108 == null))))?(((((map__42108.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42108.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__42108):map__42108);
var state = map__42108__$1;
var buf = cljs.core.get.call(null,map__42108__$1,new cljs.core.Keyword(null,"buf","buf",-213913340));
var next_line = cljs.core.get.call(null,map__42108__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var code = cljs.core.get.call(null,map__42108__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__42108__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var heading_anchors = cljs.core.get.call(null,map__42108__$1,new cljs.core.Keyword(null,"heading-anchors","heading-anchors",1713527866));
...
if(cljs.core.truth_(markdown.transformers.h1_QMARK_.call(null,(function (){var or__4126__auto__ = buf;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return next_line;
...
if(cljs.core.truth_(markdown.transformers.h2_QMARK_.call(null,(function (){var or__4126__auto__ = buf;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return next_line;
...
var temp__5733__auto__ = markdown.common.make_heading.call(null,text,heading_anchors);
...
markdown.transformers.br = (function markdown$transformers$br(text,p__42110){
...
var state = map__42111__$1;
var code = cljs.core.get.call(null,map__42111__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.call(null,map__42111__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((((cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [" "," "], null),cljs.core.take_last.call(null,(2),text))) && (cljs.core.not.call(null,(function (){var or__4126__auto__ = code;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return lists;
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__42114){
var map__42115 = p__42114;
var map__42115__$1 = (((((!((map__42115 == null))))?(((((map__42115.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42115.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__42115):map__42115);
var state = map__42115__$1;
var code = cljs.core.get.call(null,map__42115__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var frozen_strings = cljs.core.get.call(null,map__42115__$1,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace.call(null,text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__42113_SHARP_){
var vec__42117 = markdown.common.freeze_string.call(null,cljs.core.subs.call(null,p1__42113_SHARP_,(1),(cljs.core.count.call(null,p1__42113_SHARP_) - (1))),cljs.core.deref.call(null,currently_frozen));
var url = cljs.core.nth.call(null,vec__42117,(0),null);
var frozen_strings__$1 = cljs.core.nth.call(null,vec__42117,(1),null);
...
return ["0",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42121)].join('');
} else {
return G__42121;
}
});
...
})())?text:clojure.string.replace.call(null,text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__42120_SHARP_){
var encoded = cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,encoder,cljs.core.subs.call(null,p1__42120_SHARP_,(1),(cljs.core.count.call(null,p1__42120_SHARP_) - (1)))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__42122){
...
var state = map__42123__$1;
var inline_heading = cljs.core.get.call(null,map__42123__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
if(cljs.core.truth_(((cljs.core.not.call(null,last_line_empty_QMARK_))?cljs.core.not_empty.call(null,text):false))){
return [" ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(text)].join('');
} else {
return text;
}
});
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__42125){
...
var state = map__42126__$1;
var eof = cljs.core.get.call(null,map__42126__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.call(null,map__42126__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.call(null,map__42126__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.call(null,map__42126__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.call(null,map__42126__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.call(null,map__42126__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.call(null,map__42126__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.call(null,map__42126__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__42126__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.call(null,map__42126__$1,new cljs.core.Keyword(null,"code","code",1586293142));
...
if(cljs.core.truth_(((cljs.core.not.call(null,eof))?(((!(clojure.string.blank_QMARK_.call(null,text))))?(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818).cljs$core$IFn$_invoke$arity$1(temp);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__42128){
...
var state = map__42129__$1;
var next_line = cljs.core.get.call(null,map__42129__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var paragraph = cljs.core.get.call(null,map__42129__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
if(cljs.core.truth_((function (){var and__4115__auto__ = paragraph;
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last.call(null,(3),(function (){var G__42131 = next_line;
if((G__42131 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__42131);
}
})()));
} else {
return and__4115__auto__;
...
markdown.transformers.code = (function markdown$transformers$code(text,p__42132){
...
var state = map__42133__$1;
var eof = cljs.core.get.call(null,map__42133__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__42133__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code = cljs.core.get.call(null,map__42133__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__42133__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var paragraph = cljs.core.get.call(null,map__42133__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__42135){
...
var state = map__42136__$1;
var codeblock = cljs.core.get.call(null,map__42136__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var codeblock_end = cljs.core.get.call(null,map__42136__$1,new cljs.core.Keyword(null,"codeblock-end","codeblock-end",1507794736));
var indented_code = cljs.core.get.call(null,map__42136__$1,new cljs.core.Keyword(null,"indented-code","indented-code",-904930175));
var next_line = cljs.core.get.call(null,map__42136__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.call(null,map__42136__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim.call(null,text);
var next_line_closes_QMARK_ = cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last.call(null,(3),(function (){var G__42138 = next_line;
if((G__42138 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__42138);
}
})()));
...
var vec__42139 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_,"\n"),cljs.core.drop.call(null,(3),trimmed));
var lang = cljs.core.nth.call(null,vec__42139,(0),null);
var code = cljs.core.nth.call(null,vec__42139,(1),null);
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__42142){
...
var state = map__42143__$1;
var eof = cljs.core.get.call(null,map__42143__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.call(null,map__42143__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__42143__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var lists = cljs.core.get.call(null,map__42143__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim.call(null,text);
if(cljs.core.truth_((function (){var or__4126__auto__ = code;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__42145){
...
var state = map__42146__$1;
var blockquote_start = cljs.core.get.call(null,map__42146__$1,new cljs.core.Keyword(null,"blockquote-start","blockquote-start",276074935));
var blockquote_end = cljs.core.get.call(null,map__42146__$1,new cljs.core.Keyword(null,"blockquote-end","blockquote-end",1122544964));
var blockquote_paragraph = cljs.core.get.call(null,map__42146__$1,new cljs.core.Keyword(null,"blockquote-paragraph","blockquote-paragraph",1931783682));
var lists = cljs.core.get.call(null,map__42146__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__42148_SHARP_),"</ol>"].join('');
}).call(null,cljs.core.reduce.call(null,(function (footnotes__$1,p__42149){
var vec__42150 = p__42149;
var id = cljs.core.nth.call(null,vec__42150,(0),null);
var label = cljs.core.nth.call(null,vec__42150,(1),null);
...
var vec__42153 = cljs.core.re_matches.call(null,/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.call(null,vec__42153,(0),null);
var key = cljs.core.nth.call(null,vec__42153,(1),null);
var val = cljs.core.nth.call(null,vec__42153,(2),null);
var vec__42156 = cljs.core.re_matches.call(null,/^    (.*)$/,line);
var ___$1 = cljs.core.nth.call(null,vec__42156,(0),null);
var next_val = cljs.core.nth.call(null,vec__42156,(1),null);
...
var vec__42162 = ((cljs.core.sequential_QMARK_.call(null,data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.call(null,vec__42162,(0),null);
var val = cljs.core.nth.call(null,vec__42162,(1),null);
...
var G__42165 = cljs.core.merge.call(null,acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val]));
var G__42166 = cljs.core.rest.call(null,remain);
var G__42167 = key;
acc = G__42165;
remain = G__42166;
prev_key = G__42167;
...
var temp__5733__auto__ = markdown.transformers.parse_metadata_line.call(null,line);
if(cljs.core.truth_(temp__5733__auto__)){
...
return cljs.reader.read_string.call(null,clojure.string.join.call(null,"\n",cljs.core.take_while.call(null,cljs.core.comp.call(null,cljs.core.not,cljs.core.partial.call(null,cljs.core.re_matches,/\s*/)),lines_seq)));
});
/**
...
//# sourceMappingURL=transformers.js.map?rel=1606929278996
