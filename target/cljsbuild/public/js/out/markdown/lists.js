...
return clojure.string.join.call(null,(function (){var iter__4529__auto__ = (function markdown$lists$close_lists_$_iter__41428(s__41429){
return (new cljs.core.LazySeq(null,(function (){
var s__41429__$1 = s__41429;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__41429__$1);
if(temp__5735__auto__){
var s__41429__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__41429__$2)){
var c__4527__auto__ = cljs.core.chunk_first.call(null,s__41429__$2);
var size__4528__auto__ = cljs.core.count.call(null,c__4527__auto__);
var b__41431 = cljs.core.chunk_buffer.call(null,size__4528__auto__);
if((function (){var i__41430 = (0);
while(true){
if((i__41430 < size__4528__auto__)){
var vec__41432 = cljs.core._nth.call(null,c__4527__auto__,i__41430);
var list_type = cljs.core.nth.call(null,vec__41432,(0),null);
cljs.core.chunk_append.call(null,b__41431,["</li></",cljs.core.name.call(null,list_type),">"].join(''));

var G__41438 = (i__41430 + (1));
i__41430 = G__41438;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__41431),markdown$lists$close_lists_$_iter__41428.call(null,cljs.core.chunk_rest.call(null,s__41429__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__41431),null);
}
} else {
var vec__41435 = cljs.core.first.call(null,s__41429__$2);
var list_type = cljs.core.nth.call(null,vec__41435,(0),null);
return cljs.core.cons.call(null,["</li></",cljs.core.name.call(null,list_type),">"].join(''),markdown$lists$close_lists_$_iter__41428.call(null,cljs.core.rest.call(null,s__41429__$2)));
}
} else {
return null;
}
...
return iter__4529__auto__.call(null,lists);
})());
});
...
var lists_to_close = cljs.core.take_while.call(null,(function (p1__41439_SHARP_){
return (cljs.core.second.call(null,p1__41439_SHARP_) > num_indents);
...
var vec__41440 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__41440,(0),null);
var indents = cljs.core.nth.call(null,vec__41440,(1),null);
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ul","ul",-1349521403),list_type,num_indents,indents,(function (){var or__4126__auto__ = markdown.common.make_heading.call(null,content,false);
...
var vec__41443 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__41443,(0),null);
var indents = cljs.core.nth.call(null,vec__41443,(1),null);
var num_indents = cljs.core.count.call(null,cljs.core.take_while.call(null,cljs.core.partial.call(null,cljs.core._EQ_," "),text));
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ol","ol",932524051),list_type,num_indents,indents,(function (){var or__4126__auto__ = markdown.common.make_heading.call(null,content,false);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return content;
...
markdown.lists.li = (function markdown$lists$li(text,p__41446){
...
var state = map__41447__$1;
var codeblock = cljs.core.get.call(null,map__41447__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__41447__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.call(null,map__41447__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__41447__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
if(cljs.core.truth_(((cljs.core.not.call(null,eof))?(function (){var and__4115__auto__ = lists;
if(cljs.core.truth_(and__4115__auto__)){
return clojure.string.blank_QMARK_.call(null,text);
} else {
return and__4115__auto__;
...
//# sourceMappingURL=lists.js.map?rel=1606929277808
