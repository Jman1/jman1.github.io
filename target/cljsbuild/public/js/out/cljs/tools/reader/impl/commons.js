...
var G__47934 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__47934;
continue;
} else {
return ch;
...
var vec__47935 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__47935,(0),null);
return (match === s);
});
...
while(true){
if((i__4737__auto___47941 < len__4736__auto___47940)){
args__4742__auto__.push((arguments[i__4737__auto___47941]));

var G__47942 = (i__4737__auto___47941 + (1));
i__4737__auto___47941 = G__47942;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq47938){
...
return (function() { 
var G__47943__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__47943 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__47944__i = 0, G__47944__a = new Array(arguments.length -  1);
while (G__47944__i < G__47944__a.length) {G__47944__a[G__47944__i] = arguments[G__47944__i + 1]; ++G__47944__i;}
  _ = new cljs.core.IndexedSeq(G__47944__a,0,null);
} 
return G__47943__delegate.call(this,rdr,_);};
G__47943.cljs$lang$maxFixedArity = 1;
G__47943.cljs$lang$applyTo = (function (arglist__47945){
var rdr = cljs.core.first(arglist__47945);
var _ = cljs.core.rest(arglist__47945);
return G__47943__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1606929288498
